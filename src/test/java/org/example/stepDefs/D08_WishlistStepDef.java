...
public class D08_WishlistStepDef {
    ...
    P05_wishListPage  wish = new P05_wishListPage(Hooks.driver);
    int num;
    ...
    public void successNotification() {
        ...
        soft.assertTrue(home.wishSuccessMsg().isDisplayed(), "Success Message Not Display");
